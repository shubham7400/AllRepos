package com.blueduck.dajumgum.photoediting
...
import com.blueduck.dajumgum.photoediting.EmojiBSFragment.EmojiListener
import com.blueduck.dajumgum.photoediting.StickerBSFragment.StickerListener
import com.blueduck.dajumgum.photoediting.base.BaseActivity
import com.blueduck.dajumgum.photoediting.filters.FilterListener
import com.blueduck.dajumgum.photoediting.filters.FilterViewAdapter
import com.blueduck.dajumgum.photoediting.tools.EditingToolsAdapter
import com.blueduck.dajumgum.photoediting.tools.EditingToolsAdapter.OnItemSelected
                    ...
                    lifecycleScope.launch {
                        if (created && filePath != null) {
                            ...
                            if (result is SaveFileResult.Success) {
                                ...
                                // Create the intent to send back the result to MainActivity
                                val resultIntent = Intent().putExtra("returnedUri", mSaveImageUri)

                                // Set the result as OK and pass the result intent
                                setResult(Activity.RESULT_OK, resultIntent)

                                // Finish EditImageActivity
                                finish()
                            } else {
                                hideLoading()
